 ...
 */
UCLASS()
class FACTIONSRUNTIME_API UFactionsLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = Factions)
	static FFaction RegisterFaction(const FName& Name, const FFactionInfo& FactionInfo);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = Factions)
	static bool UnregisterFaction(FFaction Faction);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = Factions)
	static bool RegisterRelation(const FFactionRelation& NewRelation);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = Factions)
	static bool UnregisterRelation(const FFactionRelation& Relation);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = Factions,
		meta = (WorldContext = "ContextObject", AdvancedDisplay="ActorClass", DeterminesOutputType = "ActorClass", DynamicOutputParam = "OutActors"))
	static bool GetAllActorsWithFaction(const UObject* ContextObject, const FFaction Faction, EFactionTestMode Comparison, TSubclassOf<AActor> ActorClass,
